...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Chuck Stearns"
    user-mail-address "chuck.stearns@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/chuck/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/chuck/bin" "/profile/bin" "/Users/chuck/.npm-packages/bin" "/Users/chuck/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
